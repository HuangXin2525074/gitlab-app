...
const gitlabService = require("../service/gitlab-service");
...
exports.handler = async (event) => {
  ...
  try {
    ...
    switch (method) {
       case "save-gitlab-data":
        return await gitlabService.saveGitlabDataService(params);
       case "clear-gitlab-data":
        return await gitlabService.clearGitlabDataService(params);      
      default:
        return Responses._400({
          status_code: 400,
